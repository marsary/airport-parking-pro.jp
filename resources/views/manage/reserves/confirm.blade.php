  ...
  <div class="l-container__inner">
    ...
    <form action="{{route('manage.reserves.store')}}" method="POST">
      ...
      <div class="c-button-group__form u-mt3">
        ...
        <button type="button" onclick="submit();" name="confirm_btn" value="1" id="confirmButton" class="c-button__submit--green u-h50">予約を完了する</button>
        <button type="button" onclick="submit();" name="to_register" value="0" class="c-button__pagination--next">お会計へ</button>
