...
<main class="l-wrap__main">
  ...
  <ul class="l-wrap__breadcrumb l-breadcrumb">
    <li class="l-breadcrumb__list">満車設定</li>
  </ul>
  ...
  <div class="l-container__inner">
    ...
    <h2 class="c-title__lv2 u-mb2">満車登録</h2>
          ...
          @for ($i = 0; $i < 6; $i++)
            <div class="stock-header-container">
              <div class="stock-headers">
                <div class="stock-header-item">入庫</div>
                <div class="stock-header-item">出庫</div>
                <div class="stock-header-item">またぎ</div>
              </div>
            </div>
          @endfor
        </div>
